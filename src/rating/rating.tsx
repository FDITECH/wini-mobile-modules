...
export default class Rating extends React.Component<RatingProps, RatingState> {
  ...
  render(): React.ReactNode {
    return (
      <View style={[{ gap: 4, flexDirection: 'row' }, this.props.style ?? {}]}>
          ...
          return (
            <TouchableOpacity
              ...
              onPress={
                this.props.onChange
                  ? () => {
                      if (this.props.onChange) this.props.onChange(i + 1);
                    }
                  : undefined
              }
            >
